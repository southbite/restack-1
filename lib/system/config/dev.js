var config = {
	...
	routes:{
		auth:['createUser', 'confirmUser', 'linkUserToAccount', 'createRole', 'assignRole', 'createAccount', 'confirmAccount', 'login', 'availableAccounts', 'getRolePermissions', 'setRolePermissions'],
		data:['model', 'find', 'create', 'update', 'delete', 'getTypePermissions', 'setTypePermissions']
	},
	loggingEnabled:true,
