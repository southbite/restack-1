var config = {
	...
	routes:{
		data:['createUser', 'confirmUser', 'linkUserToAccount', 'createRole', 'assignRole', 'createAccount', 'confirmAccount', 'login', 'availableAccounts', 'getRolePermissions', 'setRolePermissions'],
		auth:['model', 'find', 'create', 'update', 'delete', 'getTypePermissions', 'setTypePermissions']
	}
}
