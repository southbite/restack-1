var config = {
	port:7777,
	plugins:{
		cacheHelper:{plugin:require('../plugins/restack_cache'),options:{
			dbKey:'restack'
		}},
		dataHelper:{plugin:require('../plugins/restack_data'),options:{
			connectionURL:'mongodb://127.0.0.1:27017/restack'

		}},
		notificationHelper:{plugin:require('../plugins/restack_notification'),options:{
