var authorization =  {
		...
		update:function(req, res, next)
		{
			...
			else if (req.operation.type == 'Account' && req.method == 'POST')
			{
				...
				_this.restack.authorizationHelper.linkAccountOwner({credentials:req.operation.credentials, account:req.operation.payload[0]}, function(e, userAccount){
					if (!e)
					{
						req.operation.payload[0].userAccount = userAccount;
						next();
					}
					else
						next(e);
