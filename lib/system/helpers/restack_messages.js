var messagesHelper = {
	...
	{
		return this.performReplace("Concurrency check failed: The {{type}} with id: {{id}} has the higher systemVersion: {{systemVersion}}", {type:type,id:id,systemVersion:systemVersion});
	}
}
