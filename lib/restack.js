var restack = {
	...
	initialize:function(params, done){
		...
		try
		{
			...
			if (this.settings.middleware.headers != null)
				this.middleware.headers =  this.settings.middleware.headers;
			else
				this.middleware.headers = require('./system/middleware/headers');
