	...
	*/
	...
	start:function(done){
		...
		//{
			...
			.get('/data/permissions/:type',this.middleware.router.getTypePermissions)
			.get('/data/:type/model', this.middleware.router.model)
			.get('/data/:type/find', this.middleware.router.find)
			.get('/data/:type', this.middleware.router.getAll)
			.get('/data/:type/:id', this.middleware.router.getById)
			.post('/data/:type', this.middleware.router.create)
			.put('/data/:type', this.middleware.router.update)
			.delete('/data/:type/:id', this.middleware.router['delete'])
