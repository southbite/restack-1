	...
	*/
	...
	start:function(done){
		...
		try
		{
			...
			.get('/auth/permissions/:type',this.middleware.router.permissions)
			.get('/data/:type/model', this.middleware.router.model)
			.post('/data/:type/find', this.middleware.router.find)
			.get('/data/:type', this.middleware.router.getAll)
			.get('/data/:type/get', this.middleware.router.getById)
