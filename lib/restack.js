	...
	*/
	...
	initialize:function(params, done){
		...
		//{
			...
			if (this.settings == null)
				this.settings = require('./system/config/test');
			...
			var standardHelpers = {
				cacheHelper			: './system/helpers/restack_cache',
				validationHelper	: './system/helpers/restack_validation',
				concurrencyHelper	: './system/helpers/restack_concurrency',
				dataHelper			: './system/helpers/restack_data',
				authorizationHelper	: './system/helpers/restack_authorization',
				authenticationHelper: './system/helpers/restack_authentication',
				inputOutputHelper	: './system/helpers/restack_input_output_formatter',
				notificationHelper	: './system/helpers/restack_notification',
				messagesHelper		: './system/helpers/restack_messages',
				dataCacheHelper		: './system/helpers/restack_data_cache',
				pubSubHelper		: './system/helpers/restack_pubsub'
			};
			...
			var standardMiddleware = {
				...
				pubsub			: "./system/middleware/pubsub"
			};
	...
	start:function(done){
		...
		//{
			...
			.use(this.middleware.router.bind(this.middleware.router))
			...
			.use(this.middleware.data.auditCheck.bind(this.middleware.history))
			...
			.use(this.middleware.data.audit.bind(this.middleware.history))
			...
			.use(this.middleware.pubsub.check.bind(this.middleware.pubsub))
	...
	log:function(params, done){
		...
		try
		{
			...
			if (typeof params == "object" && params.msg != undefined)
				msg = params.msg;
			else
				msg = params;
